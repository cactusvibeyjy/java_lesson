...
<body>
	<%
		MultipartRequest multi = new MultipartRequest(request, "C:\\upload_0811", 10 * 1024 * 1024, "utf-8", 	new DefaultFileRenamePolicy());
	...
	<table border="1">
		<tr>
			<th width="100">이름</th>
			<th width="100">제목</th>
			<th width="100">file1-3</th>
			<th width="100">filename1-3</th>
		</tr>
		<%
